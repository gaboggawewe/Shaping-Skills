...
#Variables
minimum_repetitions = 30  #para filtrarlas, entre más alto, menos competencias
minimum_weight = 7  #para filtrar las conexiones, entre más alto, menos conexiones
minimum_connections = 5    #para filtrar los nodos, entre más alto, menos nodos
node_size = 8   #tamaño de los nodos
node_separation = 7   #separación entre nodos
