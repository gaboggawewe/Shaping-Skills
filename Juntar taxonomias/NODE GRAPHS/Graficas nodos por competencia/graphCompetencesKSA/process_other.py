...
#Variables
minimum_repetitions = 10  #para filtrarlas, entre más alto, menos competencias
minimum_weight = 3  #para filtrar las conexiones, entre más alto, menos conexiones
minimum_connections = 2    #para filtrar los nodos, entre más alto, menos nodos
